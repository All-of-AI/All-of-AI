...
class BertModel(object):
    ...
    def __init__(self, config, is_training, input_ids, input_mask=None, token_type_ids=None,
        ...
        Args:
            ...
            use_one_hot_embeddings: (optional) bool. Whether to use one-hot word embeddings or tf.embedding_lookup()
...
def dropout(input_tensor, dropout_prob):
    ...
    Args:
        ...
        dropout_prob: Python float. The probability of dropping out a value (NOT of *keeping* a dimension as
            in `tf.nn.dropout`).
