...
def is_whitespace(char):
    """判断'char'是否为空格字符"""
    # \t, \n, and \r are technically contorl characters but we treat them as whitespace since
    # they are generally considered as such.
...
def is_punctuation(char):
    ...
    # Characters such as "^", "$", and "`" are not in the Unicode Punctuation class but we treat them as
